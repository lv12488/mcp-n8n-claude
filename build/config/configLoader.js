...
class ConfigLoader {
    ...
    loadConfig() {
        ...
        const configPaths = [
            ...
            path_1.default.join(__dirname, '../../.config.json'), // Relative to build/config/configLoader.js
            path_1.default.join(__dirname, '../../../.config.json') // In case of different build structure
        ];
    ...
    loadFromEnv() {
        ...
        const envPaths = [
            ...
            path_1.default.join(__dirname, '../../.env'), // Relative to build/config/configLoader.js
        ];
